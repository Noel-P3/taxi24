...
INSERT INTO
    public."Pasajeros"(nombre, apellido)
VALUES
    ('Andres', 'Soto');
...
DO $ $ DECLARE pasajero_record RECORD;

-- Cambiado a pasajero_record
...
BEGIN -- Iterar sobre los primeros 60 pasajeros
FOR pasajero_record IN
SELECT
    id
FROM
    public."Pasajeros"
